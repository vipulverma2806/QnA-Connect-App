  ...
  return (
    <div className="min-h-screen bg-gray-900 flex justify-center items-center">
      <form className="bg-gray-800 flex flex-col p-6  rounded-2xl space-y-5 max-w-sm w-full">
        <h1 className="text-gray-100 text-center text-2xl font-bold">Register</h1>
        <input
          type="text"
          placeholder="Name"
        ...
        <p className="text-gray-200 ">Already have an account :         <Link to='/' className="hover:underline text-blue-500"> Login</Link></p>
      </form>
    </div>
  );
};
